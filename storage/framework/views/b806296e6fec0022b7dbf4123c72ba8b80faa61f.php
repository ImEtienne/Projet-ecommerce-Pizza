...
<?php $__env->startSection('contents'); ?>
    <p>Formulaire pour la création du compte Pizzaiolo</p>

    <form action="<?php echo e(route('admin.users.createPizzaiolo')); ?>" method="POST">
        <div class="mb-3">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\pizza\resources\views/admin/users/createPizzaiolo.blade.php ENDPATH**/ ?>