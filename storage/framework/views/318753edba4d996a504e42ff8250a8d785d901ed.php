...
<?php $__env->startSection('contents'); ?>
    ...
    <form action ="<?php echo e(route('admin.users.editpassword', ['id'=>$users->id])); ?>" method="POST">
        Nouveau mot de passe: <input type="password" name="mdp_" placeholder="Mot de passe" required>
